...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('modelo/cafeteria.jpg');
            /* Ruta de la imagen */
            ...
            /* Centra la imagen */
            height: 100vh;
            /* Establece la altura del fondo al 100% del viewport */
            margin: 0;
            /* Elimina el margen por defecto del cuerpo */
            padding: 0;
            /* Elimina el relleno por defecto del cuerpo */
        }

        .container {
            background-color: rgba(255, 255, 255, 0.9);
            /* Agrega un fondo semi-transparente a los contenidos para mejorar la legibilidad */
            padding: 20px;
            /* Añade relleno para separar los contenidos del fondo */
        }
    </style>
</head>
...
<body>
            ...
            <tbody>
                ...
                while ($fila = $resultado_ventas_productos->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?php echo $fila['nombre_producto']; ?> (Cantidad: <?php echo $fila['cantidad']; ?>, Precio
                            Unitario: $<?php echo $fila['precio_venta']; ?>)</td>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#tablaVentas_length").find("select").prepend('<option value="5">5</option>');
