...
<head>
    ...
    <style>
        ...
        .navbar {
            margin-bottom: 20px;
            /* Agrega un margen inferior a la barra de navegación */
            width: 100%;
        ...
        .center-container {
            ...
            /* Apila el mensaje y la imagen verticalmente */
            justify-content: center;
            /* Centra horizontalmente */
            align-items: center;
            /* Centra verticalmente */
            height: calc(100vh - 56px);
            /* Resta el tamaño de la barra de navegación */
        }
...
<body>
    <!-- Barra de navegación -->
    <?php
    include "vistas/navbar_main.php";
    ?>
    <!-- Contenedor centrado -->
